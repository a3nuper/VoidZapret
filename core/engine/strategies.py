...
# Порядок калибровки: от простого к сложному. Первый прошедший с лучшим пингом —
# и есть рабочий метод для данного провайдера.
STRATEGIES = ["fakesplit", "fake", "split", "disorder", "seqovl"]
